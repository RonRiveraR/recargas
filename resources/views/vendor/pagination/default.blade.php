        ...
        <ul class="pagination">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <li class="btn btn-light border disabled" aria-disabled="true"><span>{{ $element }}</span></li>
                @endif
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="btn btn-light border active" aria-current="page"><span>{{ $page }}</span></li>
                        @else
                            <li><a class="btn btn-light border" href="{{ $url }}">{{ $page }}</a></li>
                        @endif
                    @endforeach
                @endif
            @endforeach
