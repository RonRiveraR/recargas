$(document).ready(function () {
    var divLoaderSocio = '<div class="mt-3 text-center"><img src="images/loader.gif"></div>';
    $('#divTotal').hide();
    $('#botonForm').hide();
    $('#divCaptura').hide();
    ...
    $('#selectServicio').change(function () {
        ...
        $('body').on('change', '#recargasMoviles', function () {
            switch ($('body #recargasMoviles').val()) {
                case 'TELCEL':
                    LimpiarOpciones1();
                    $('body #numero').html('<div class="mt-3 text-center"><img src="images/loader.gif"></div>');
            ...
            $('#monto').val('');
                ...
                $('body').on('change', '#recargasMovilesTelcel', function () {
                    switch ($('body #recargasMovilesTelcel').val()) {
                        case 'Recarga de tiempo libre':
                            LimpiarOpciones2();
                            $('body #formMonto').html('<div class="mt-3 text-center"><img src="images/loader.gif"></div>');
                    ...
                    $('#monto').val('');
                                        ...
                                        $('body').on('change', '#RMTelcelMontoTiempoLibre', function () {
                                            switch ($('body #RMTelcelMontoTiempoLibre').val()) {
                                                case '10':
                                                    LimpiarOpciones3();
                                                    $('body #adicional').html('<div class="mt-3 text-center"><img src="images/loader.gif"></div>');
                ...
                $('body').on('change', '#recargasMovilesIusacell', function () {
                    switch ($('body #recargasMovilesIusacell').val()) {
                        case '15':
                            LimpiarOpciones2();
                            // $('body #botonForm').html('<div class="mt-3 text-center"><img src="images/loader.gif"></div>');
                            $('#divTotal').show();
        ...
        $('body').on('change', '#pinesElectronicos', function () {
            switch ($('body #pinesElectronicos').val()) {
                ...
                ===================================*/
                $('body').on('change', '#pinesRixty', function () {
                ...
                $('body').on('change', '#chichuachuaProducto', function () {
                    switch ($('body #chichuachuaProducto').val()) {
                        case 'Tesoreria de Chihuahua':
                            LimpiarOpciones2();
                            $('body #formMonto').html('<div class="mt-3 text-center"><img src="images/loader.gif"></div>');
                                $('body #formMonto').load('html/formularios.html #chihuahuaMonto');
                            $('body #adicional').load('html/formularios.html #cargo08');
                                $('#divTotal').show();
                                $('#divCaptura').show();
                                    $('#botonForm').show();
...
$('#btnConfirm').click(function (e) {
    ...
    datosFormModal += '<div class="col-7 m-0" id="datosModal">';
            ...
            function readURL(input) {
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function(e) {
                        ...
                        $('#contenedorImagen').html(divLoaderSocio);
...
$('#formularioInicio').submit(function () {
...
});// FIN DE VALIDACION DE FORMULARIO DE REGISTRO
